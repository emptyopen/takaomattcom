  ...
  return (
    <>
      ...
      <main className="hero-card">
        ...
        <h1 className="job">SWE @ Google, AI Infra for Search</h1>

          <div className="hero-socials">
            <a
              href="https://www.linkedin.com/in/takaomatt/"
              target="_blank"
              rel="noreferrer"
              aria-label="LinkedIn"
            >
            ...
            <a
              href="https://www.instagram.com/takeezi/"
              target="_blank"
              rel="noreferrer"
            ...
            <a
              href="https://github.com/emptyopen"
              target="_blank"
              rel="noreferrer"
              aria-label="GitHub"
            >
          ...
          <h3 className="proj">
            Now building{' '}
            <a href="https://pianomania.gg" target="_blank" rel="noreferrer">
              pianomania.gg
            </a>
          </h3>
      </main>
